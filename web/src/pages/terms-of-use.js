        ...
        <div className="container">
          ...
          <ol className="list-disc pl-6 mb-6">
            <li>
              ...
              materials (information or software) on Deeply Nourished's web site
              ...
              <ol className="list-decimal pl-6 mb-6">
                ...
                <li>
                  ...
                  contained on Deeply Nourished's web site;
                </li>
                <li>
            ...
            <li>
              ...
              these restrictions and may be terminated by Deeply Nourished at
          ...
          <ol className="list-disc pl-6 mb-6">
            <li>
              The materials on Deeply Nourished's web site are provided "as is".
              Deeply Nourished makes no warranties, expressed or implied, and
              hereby disclaims and negates all other warranties, including
              without limitation, implied warranties or conditions of
              merchantability, fitness for a particular purpose, or
              non-infringement of intellectual property or other violation of
              rights. Further, Deeply Nourished does not warrant or make any
          ...
          <h3>4. Limitations</h3>
          <p>
            In no event shall Deeply Nourished or its suppliers be liable for
            any damages (including, without limitation, damages for loss of data
            or profit, or due to business interruption,) arising out of the use
            or inability to use the materials on Deeply Nourished's Internet
            site, even if Deeply Nourished or a Deeply Nourished authorized
          ...
          <p>
            ...
            Deeply Nourished does not, however, make any commitment to update
            the materials.
          </p>
          <h3>6. Links</h3>
          <p>
            Deeply Nourished has not reviewed all of the sites linked to its
            ...
            endorsement by Deeply Nourished of the site. Use of any such linked
            web site is at the user's own risk.
          </p>
          <h3>7. Site Terms of Use Modifications</h3>
          <p>
            Deeply Nourished may revise these terms of use for its web site at
          ...
          <p>
            Any claim relating to Deeply Nourished's web site shall be governed
